<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GenDoc.aspx.cs" Inherits="wordForm_GenDoc" %>
    ...
    <!--************** Start of AceoffixCtrl JavaScript ************************-->
		<script type="text/javascript">
		    ...
		    function poSetFullScreen() {
		        document.getElementById("AceoffixCtrl1").FullScreen = !document
						.getElementById("AceoffixCtrl1").FullScreen;
		    }
		</script>
