<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubmitDataOfDoc.aspx.cs" Inherits="wordForm_SubmitDataOfDoc" %>
...
<script type="text/javascript">
	function OnWordDataRegionClick(Name, Value, Left, Bottom) {
		...
		if (Name == "ACE_dept") {
		    ...
		    var strRet = document.getElementById("AceoffixCtrl1").ShowHtmlModalDialog("selectDept.htm", Value, "left=" + Left + "px;top=" + Bottom + "px;width=270px;height=270px;frame=no;");
		    if (strRet != "") {
		        return (strRet);
		    }
		    else {
