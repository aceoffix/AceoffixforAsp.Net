<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word2.aspx.cs" Inherits="fullscreen_word2" %>
...
<title>Acesoft Corporation -  How to open document with full screen window</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>How to open document with full screen window</em></strong></span></div>
        <div class="right">
...
<script language="javascript" type="text/javascript">
    function AfterDocumentOpened() {
        document.getElementById("AceoffixCtrl1").FullScreen = true;
    }
