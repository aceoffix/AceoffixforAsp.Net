<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="passParameters_word" %>
...
<title>Acesoft Corporation - Pass parameter to the save page specified by SaveFilePage property</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Pass parameter to the save page specified by SaveFilePage property</em></strong></span></div>
        <div class="right">
...
<!--************** End of AceoffixCtrl JavaScript ************************-->
    ...
    <div style="font-size: 14px;">
        <span style="color: Red;">Personnel Information:</span><br />
        <input id="Hidden1" name="age" type="hidden" value="25" />
        <span style="color: Red;">Name:</span><input id="Text1" name="userName" type="text" value="Tom" /><br />
        <span style="color: Red;">Gender:</span><select id="Select1" name="selSex">
