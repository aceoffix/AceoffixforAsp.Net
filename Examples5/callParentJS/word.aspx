<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="callParentJS_word" %>
...
<title>Acesoft Corporation -  Call-back Javascript functions from the parent page</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Call-back Javascript functions from the parent page</em></strong></span></div>
        <div class="right">
