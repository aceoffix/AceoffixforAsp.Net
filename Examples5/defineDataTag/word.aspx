<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="defineDataTag_word" %>
...
<title>Acesoft Corporation -  User defines the location of DataTag in the template</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>User defines the location of DataTag in the template</em></strong></span></div>
        <div class="right">
...
<script type="text/javascript">
    ...
    function locateTag(tagName) {
        ...
        if (!bFind) {
            document.getElementById("AceoffixCtrl1").Alert("The end has search to document.");
            appSlt.HomeKey(6);
        }
        window.focus();
    ...
    function ShowDefineDataTags() {
        document.getElementById("AceoffixCtrl1").ShowHtmlModelessDialog("DataTagDlg.htm", "parameter=xx", "left=300px;top=390px;width=450px;height=410px;frame:no;");
