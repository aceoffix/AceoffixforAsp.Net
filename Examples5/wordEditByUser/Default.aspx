<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="wordEditByUser_Default" %>
...
<title>Acesoft Corporation - Different users can simultaneously modify different regions in one Word document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Different users can simultaneously modify different regions in one Word document</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
     ...
     <form id="form1" action="word.aspx" method="post">
    <div style=" text-align:center;">
    <div>Select one user to log in:</div><br />
    <select name="userName">
        <option selected="selected" value="Tom">User A:Tom</option>
        <option  value="Jack">User B:Jack</option>
    </select><br /><br />
    <input type="button"  value="Open File" onclick="javascript:AceBrowser.openWindowModeless('word.aspx?userName='+form1.userName.value,'width=1200px;height=800px;');" />
    <br /><br />
    <div style=" color:Red;">Users can log in and edit their own regions in this document.</div>
    </div>
    </form>
