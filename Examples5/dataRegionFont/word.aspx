<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="dataRegionFont_word" %>
...
<title>Acesoft Corporation -  Set font of the text in DataRegion</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Set font of the text in DataRegion</em></strong></span></div>
        <div class="right">
...
<div class="container left">
  <form id="form1" runat="server">
    This demo shows how to program to set the font of the text in DataRegion. 
<a href="word2.aspx">Please click and check the original document.</a><br /><br />
