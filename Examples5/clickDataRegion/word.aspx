<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="clickDataRegion_word" %>
...
<title>Acesoft Corporation - How to capture the click event in DataRegion</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>How to capture the click event in DataRegion</em></strong></span></div>
        <div class="right">
				...
				<script type="text/javascript">
				    ...
				    function OnWordDataRegionClick(Name, Value, Left, Bottom) {
				        ...
				        if (Name == "ACE_test") {
				            ...
				            var strRet = document.getElementById("AceoffixCtrl1").ShowHtmlModalDialog("selectDept.htm", Value, "left=" + Left + "px;top=" + Bottom + "px;width=400px;height=200px;frame=no;");
