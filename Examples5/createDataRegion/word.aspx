<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="createDataRegion_word" %>
...
<title>Acesoft Corporation -  Create DataRegion</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Create DataRegion</em></strong></span></div>
        <div class="right">
...
<div class="container left">
 ...
 <form id="form1" runat="server">
    ...
    Key Code:<br/>
 Aceoffix.WordWriter.DataRegion dataRegion1 = doc.CreateDataRegion("Paragraph1", Aceoffix.WordWriter.DataRegionInsertType.After, "[home]");<br/>
  This method creates a new DataRegion and returns a DataRegion object.<br/>
 The first parameter is the name of new DataRegion.<br/> The second parameter is the inserting mode of new DataRegion. <br/>
 The third parameter is the name of the relative DataRegion which is the existing DataRegion predefined by users in the document.
 But it can also be other two special DataRegions: [HOME] and [END] that are reserved by Aceoffix development platform.
  Respectively representing the cursor positions of start and end in document, [HOME]and[END] do not need to be defined manually by users.<br/>
 If the current document is a blank document without any DataRegion,
  you can use [HOME] and [END] to generate a formatted document with images and text in the blank document.<br/>
For example:<br/>
Aceoffix.WordWriter.DataRegion dataRegion1 = doc.CreateDataRegion("Paragraph1", Aceoffix.WordWriter.DataRegionInsertType.After, "[home]");<br/>
