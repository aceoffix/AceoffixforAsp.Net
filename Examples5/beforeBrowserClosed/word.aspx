...
<title>Acesoft Corporation -  How to stop user closing the window</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="#" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>How to stop user closing the window</em></strong></span></div>
        <div class="right">
            <a href="#" >Example Center</a>
        </div>
        <div class="clear"></div>
    </div>
<div class="container left">
...
<script language="javascript" type="text/javascript">
	function BeforeBrowserClosed(){
		if(document.getElementById("AceoffixCtrl1").IsDirty){
		    var str=confirm("The document is modified but not saved. Will you close it?")
  			if (str==false)
    		{
    			return false;
    		}
