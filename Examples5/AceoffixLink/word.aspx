<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="AceoffixLink_word" %>

<%@ Register Assembly="Aceoffix, Version=5.0.0.1, Culture=neutral, PublicKeyToken=e6a26169e940f541"
...
<title>Acesoft Corporation -  Use AcoeffixLink to open document online</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use AcoeffixLink to open document online</em></strong></span></div>
        <div class="right">
...
<script language="javascript" type="text/javascript">
    ...
    function AfterDocumentOpened() {
        ...
        document.getElementById("Text1").value = document.getElementById("AceoffixCtrl1").DataRegionList.GetDataRegionByName("ACE_Title").Value;
    }

    function setTitleText() {
        document.getElementById("AceoffixCtrl1").DataRegionList.GetDataRegionByName("ACE_Title").Value = document.getElementById("Text1").value;
    }
   
</script>
<p style=" text-indent:10px;" >
       AceoffixLink is a new method to open a document. This method has solved cross-browser compatibility issues perfectly.
        </p>
        <p style=" text-indent:10px;" >
        <span style=" font-weight:bold;">AceoffixLink is the hyperlink that our team specially develops for opening document online.</span>
        </p>
        <p style=" text-indent:10px;" >
       
           The code to open hyperlink of the document in an usual way: &lt;a href=&quot;Word.aspx?id=12&quot;&gt;Document name-12&lt;a&gt;</p>
        <p style=" text-indent:10px;" >
           The code to open hyperlink of the document with AceoffixLink:
       &lt;a href=&quot;<span style=" background-color:#D2E9FF;">&lt;%=AceoffixLink.openWindowModeless(request, &quot;</span>Word.aspx?id=12<span style=" background-color:#D2E9FF;">&quot;,&quot;width=800px;height=800px;&quot;)%&gt;</span>&quot;&gt;
     
            Document name-12&lt;a&gt;
            &nbsp;</p>
	Caption: <input id="Text1" type="text" size="50"      />
	<input type="button" value="modification" onclick="setTitleText();" />
