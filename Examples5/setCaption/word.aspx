<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="caption_word" %>
...
<title>Acesoft Corporation -  Modify caption of Aceoffix</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Modify caption of Aceoffix control</em></strong></span></div>
        <div class="right">
...
<div class="container left">
 <form id="form1" runat="server">
    Operation: Set the Caption property of Aceoffix control at server-side code.<br/>
    Key code: AceoffixCtrl1.Caption="This content is controlled by Caption property of AceoffixCtrl and can be set as any text you want.";
