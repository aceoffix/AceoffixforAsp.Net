<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="jsInsertPageBreak_word" %>
...
<title>Acesoft Corporation - Insert page break in where the cursor is in Word document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Insert page break in where the cursor is in Word document</em></strong></span></div>
        <div class="right">
...
<div class="container left">
   ...
   <form id="form1" runat="server">
     Description: Move the cursor to where you want to insert the page break in current document, and click "Page Break".<br/>
Key code: Right click web page and select "View source" to check the JavaScript code InsertPageBreak().
<!--************** Start of AceoffixCtrl JavaScript ************************-->    
<script language="javascript" type="text/javascript">
    function InsertPageBreak() {
        document.getElementById("AceoffixCtrl1").RunMacro("AddPage", "function AddPage() \r\n Application.Selection.InsertBreak(7) \r\n End function");
    }
</script>
