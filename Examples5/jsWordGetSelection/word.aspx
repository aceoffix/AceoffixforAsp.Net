<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="jsWordGetSelection_word" %>
...
<title>Acesoft Corporation - Get the text selected in Word document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Get the text selected in Word document</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
  <script language="javascript" type="text/javascript">
      function getSelectionText() {
          if (document.getElementById("AceoffixCtrl1").DocumentObject.Application.Selection.Range.Text != "") {
              document.getElementById("AceoffixCtrl1").Alert(document.getElementById("AceoffixCtrl1").DocumentObject.Application.Selection.Range.Text);
          }
          else {
              document.getElementById("AceoffixCtrl1").Alert("You did not choose any text.");
          }

          /*  var sMac = "function myfunc()" + "\r\n"
          + "MsgBox Application.Selection.Range.Text" + "\r\n"
          + "End function";
