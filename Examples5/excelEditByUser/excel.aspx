<%@ Page Language="C#" AutoEventWireup="true" CodeFile="excel.aspx.cs" Inherits="excelEditByUser_excel" %>
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
    ...
    <div style="width: 1000px; height: 800px;">
					<strong>User:</strong>
					<span style="color: Red;"> <asp:Literal ID="Literal1" runat="server"></asp:Literal>[Only the yellow region can be edited.]</span>
