<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="wordRibbonCtrl_word" %>
...
<title>Acesoft Corporation - Control the Ribbon bar of Word</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Control the Ribbon bar of Word</em></strong></span></div>
        <div class="right">
...
<div class="container left">
    <form id="form1" runat="server">
        Key code:AceoffixCtrl1.RibbonBar.SetTabVisible("TabHome", true);// use this code to hide the "Home" functional area in the Ribbon bar. ("TabHome" is the name of the functional area; "false" to hide, "true" to show.)<br/>
     AceoffixCtrl1.RibbonBar.SetSharedVisible("FileSave", false); //use this code to hide the "Save" button in Quick Access Toolbar. ("FileSave" is the button name; "false" to hide, "true" to show.)<br/>
      AceoffixCtrl1.RibbonBar.SetGroupVisible("GroupClipboard", false);//use this code to hide "Clipboard" in "Home" functional area. ("GroupClipboard" is the name of the panel; "false" to hide, "true" to show.)<br/>
     Note: these performances will be synchronized with the Ribbon bar in local Word document. When online-editing windows are closed, the synchronization of the Ribbon bar in local Word document will be disabled.<br/>
