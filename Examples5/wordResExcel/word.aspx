...
<title>Acesoft Corporation -  Use code to insert Excel documents in DataRegion</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use code to insert Excel documents in DataRegion</em></strong></span></div>
        <div class="right">
...
<div class="container left">
    <form id="form1" runat="server">
        Key code:Aceoffix.WordWriter.DataRegion excel = wd.OpenDataRegion("Excel");// The parameter of openDataRegion is the name of bookmark. <br/> 
