...
<title>Acesoft Corporation - Use JaveScript to hide or show each toolbar on the window of Aceoffix</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use JaveScript to hide or show each toolbar on the window of Aceoffix</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
    <script type="text/javascript">
        ...
        function Button1_onclick() {
            var bVisible = document.getElementById("AceoffixCtrl1").Titlebar;
            document.getElementById("AceoffixCtrl1").Titlebar = !bVisible;
        }

        // Hide/Show Menu Bar
        function Button2_onclick() {
            var bVisible = document.getElementById("AceoffixCtrl1").Menubar;
            document.getElementById("AceoffixCtrl1").Menubar = !bVisible;
        }

        // Hide/Show Custom Toolbar
        function Button3_onclick() {
            var bVisible = document.getElementById("AceoffixCtrl1").CustomToolbar;
            document.getElementById("AceoffixCtrl1").CustomToolbar = !bVisible;
        }
        // Hide/Show Office Toolbar
        function Button4_onclick() {
            var bVisible = document.getElementById("AceoffixCtrl1").OfficeToolbars;
            document.getElementById("AceoffixCtrl1").OfficeToolbars = !bVisible;
        }
    </script>
<!--************** End of AceoffixCtrl JavaScript ************************-->
    <form id="form1" runat="server">
    <input id="Button1" type="button" value="Hide/Show Caption Bar"  onclick="return Button1_onclick()" />
    <input id="Button2" type="button" value="Hide/Show Menu Bar" onclick="return Button2_onclick()" />
