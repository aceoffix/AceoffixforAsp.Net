<%@ Page Language="C#" AutoEventWireup="true" CodeFile="callvba.aspx.cs" Inherits="word_callvba" %>
...
<title>Acesoft Corporation - Use JavaScript to call VBA interface of Word application</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use JavaScript to call VBA interface of Word application</em></strong></span></div>
        <div class="right">
 ...
 <form id="form1" runat="server">
  <script language="javascript" type="text/javascript">
      ...
      function CallVBA1() {
          ...
          AceoffixCtrl1.DocumentObject.Paragraphs(1).Range.Font.Size = 24;
          AceoffixCtrl1.DocumentObject.Paragraphs(2).Range.Font.Color = 16711680; // wdColorBlue = 16711680
      }
      function CallVBA2() {
          var AceoffixCtrl1 = document.getElementById("AceoffixCtrl1");
          AceoffixCtrl1.DocumentObject.Application.Selection.InsertBefore("Hello World ");
      }
      function CallVBA3() {
          var AceoffixCtrl1 = document.getElementById("AceoffixCtrl1");
          AceoffixCtrl1.DocumentObject.Sections(1).Headers(1).Range.Text = "Overview"; //wdHeaderFooterPrimary = 1
          AceoffixCtrl1.DocumentObject.Sections(1).Footers(1).Range.Text = "Aceoffix";
      }
</script>

  <div style="width:auto; height:600px;">
      <ace:AceoffixCtrl ID="AceoffixCtrl1" runat="server" BorderStyle="BorderThin" 
          Menubar="False" Theme="Office2007" onload="AceoffixCtrl1_Load"
          TitlebarColor="ActiveCaption">
      </ace:AceoffixCtrl>
  </div>
    </form>
