...
public partial class word_revisionclean : System.Web.UI.Page
{
    ...
    protected void AceoffixCtrl1_Load(object sender, EventArgs e)
    {
        ...
        AceoffixCtrl1.AddCustomToolButton("Accept All Revisions", "AcceptAllRevisions()", 5);
        AceoffixCtrl1.AddCustomToolButton("-", "", 0);
        ...
        if ((strUserName != null) && (strUserName.Length > 0))
        {
            ...
            AceoffixCtrl1.OpenDocument("../doc/wordrevision.doc", Aceoffix.OpenModeType.docFinalizeDraft, strUserName);
        }
    }
}
