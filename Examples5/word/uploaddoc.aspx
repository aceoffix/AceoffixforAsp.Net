<%@ Page Language="C#" AutoEventWireup="true" CodeFile="uploaddoc.aspx.cs" Inherits="word_uploaddoc" %>
...
<title>Acesoft Corporation - Use JavaScript to open a document online</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use JavaScript to open a document online</em></strong></span></div>
        <div class="right">
...
<div class="container left">
   ...
   <p><input id="Button1" type="button" value=" Open document online " onclick="return Button1_onclick()" /></p>
...
<script language="javascript" type="text/javascript">
    ...
    function OpenlocalDlg() {
        document.getElementById("AceoffixCtrl1").ShowDialog(1); //Open dialog box
    }
    function Button1_onclick() {
        var AceoffixCtrl1 = document.getElementById("AceoffixCtrl1");
        AceoffixCtrl1.Close();
        AceoffixCtrl1.SaveFilePage = "saveuploaddoc.aspx";
        AceoffixCtrl1.OpenDocument("../doc/editword.doc", "docNormalEdit", "John Scott");
    }
...
<!--************** End of AceoffixCtrl JavaScript ************************-->
  ...
  <div style="width:auto; height:600px;">
      <ace:AceoffixCtrl ID="AceoffixCtrl1" runat="server" BorderStyle="BorderThin" 
          Menubar="False" onload="AceoffixCtrl1_Load" Theme="Office2007" 
