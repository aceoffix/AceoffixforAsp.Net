<%@ Page Language="C#" AutoEventWireup="true" CodeFile="concurrent.aspx.cs" Inherits="word_concurrent" %>
...
<title>Acesoft Corporation - Concurrent Editing Online</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Concurrent Editing Online</em></strong></span></div>
        <div class="right">
