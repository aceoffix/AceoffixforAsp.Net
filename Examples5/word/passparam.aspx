<%@ Page Language="C#" AutoEventWireup="true" CodeFile="passparam.aspx.cs" Inherits="word_passparam" %>
...
<title>Acesoft Corporation - Edit Word document online</title>
<!-- Theme styles -->
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Edit Word document online</em></strong></span></div>
        <div class="right">
  ...
  <!--************** Start of AceoffixCtrl JavaScript ************************-->
   <script language="javascript" type="text/javascript">
       ...
       function SaveAsHTML() {
           ...
           window.location = "viewhtml.aspx?mht=../doc/editword.htm";
       }
     ...
     <input type="button" id="btn1" value="Show the value of parameter" onclick="alert(window.external.Argument);"/>
    <!--************** End of AceoffixCtrl JavaScript ************************-->
  <div style="width:auto; height:600px;">
      <ace:AceoffixCtrl ID="AceoffixCtrl1" runat="server" BorderStyle="BorderThin" 
          Menubar="True" Theme="Office2007" onload="AceoffixCtrl1_Load"
