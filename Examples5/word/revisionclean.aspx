<%@ Page Language="C#" AutoEventWireup="true" CodeFile="revisionclean.aspx.cs" Inherits="word_revisionclean" %>
...
<title>Acesoft Corporation - Check and clean up all the revisions</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Check and clean up all the revisions</em></strong></span></div>
        <div class="right">
 ...
 <form id="form1" runat="server">
  <script language="javascript" type="text/javascript">
      ...
      function ShowRevisions() {
          document.getElementById("AceoffixCtrl1").ShowRevisions = !document.getElementById("AceoffixCtrl1").ShowRevisions;
      }
