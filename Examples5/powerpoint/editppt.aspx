<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editppt.aspx.cs" Inherits="powerpoint_editppt" %>
...
<title>Acesoft Corporation - Edit PowerPoint document online</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Edit PowerPoint document online</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
   <script language="javascript" type="text/javascript">
       ...
       function SaveAsHTML() {
           ...
           window.location = "viewhtml.aspx?mht=../doc/editppt.htm";
       }
...
<!--************** End of AceoffixCtrl JavaScript ************************-->
  ...
  <div style="width:auto; height:600px;">
      <ace:AceoffixCtrl ID="AceoffixCtrl1" runat="server" 
            onload="AceoffixCtrl1_Load" BorderStyle="BorderThin">
      </ace:AceoffixCtrl>
  </div>
  </form>	
</div>
