<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="wordDataTag_word" %>
...
<title>Acesoft Corporation - Use DataTag to fill text data in Word document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use DataTag to fill text data in Word document</em></strong></span></div>
        <div class="right">
