<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="wordCompare_word" %>
...
<title>Acesoft Corporation - Compare two Word documents online</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Compare two Word documents online</em></strong></span></div>
        <div class="right">
 ...
 <!--************** Start of AceoffixCtrl JavaScript ************************--> 
     <script type="text/javascript">
         function ShowFile1View() {
             document.getElementById("AceoffixCtrl1").DocumentObject.ActiveWindow.View.ShowRevisionsAndComments = false;
             document.getElementById("AceoffixCtrl1").DocumentObject.ActiveWindow.View.RevisionsView = 1;
         }
         function ShowFile2View() {
             document.getElementById("AceoffixCtrl1").DocumentObject.ActiveWindow.View.ShowRevisionsAndComments = false;
             document.getElementById("AceoffixCtrl1").DocumentObject.ActiveWindow.View.RevisionsView = 0;
         }
         function ShowCompareView() {
             document.getElementById("AceoffixCtrl1").DocumentObject.ActiveWindow.View.ShowRevisionsAndComments = true;
             document.getElementById("AceoffixCtrl1").DocumentObject.ActiveWindow.View.RevisionsView = 0;
         }
    </script>
