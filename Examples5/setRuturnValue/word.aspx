<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="setRuturnValue_word" %>
...
<title>Acesoft Corporation - Return the value of saving results customized by developer to front page after saving the document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Return the value of saving results customized by developer to front page after saving the document</em></strong></span></div>
        <div class="right">
...
<div class="container left">
   ...
   Key code: right click; choose "view source" and refer to the JavaScript function "SaveDocument()":<br/>
   document.getElementById("AceoffixCtrl1").SaveDocument(); //Save <br/>
   document.getElementById("AceoffixCtrl1").CustomSaveResult;//Set the return value<br/>
   Set the server code freq.CustomSaveResult="OK" in savefile.aspx.cs. Developer can define the this value freely.<br/>
<!--************** Start of AceoffixCtrl JavaScript ************************-->
<script language="javascript" type="text/javascript">
    function SaveDocument() {
        document.getElementById("AceoffixCtrl1").SaveDocument();
        alert(document.getElementById("AceoffixCtrl1").CustomSaveResult);
    }
</script>
