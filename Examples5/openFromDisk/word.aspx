<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="openFromDisk_word" %>
...
<title>Acesoft Corporation - Open the Office document from server disk path</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Open the Office document from server disk path</em></strong></span></div>
        <div class="right">
...
<div class="container left">
  ...
  <form id="form1" runat="server">
    Open the document from the specified server disk path.<br/>
     The disk path is <asp:Literal ID="Literal_Info" runat="server"></asp:Literal>
...
<!--************** End of AceoffixCtrl JavaScript ************************-->
    <div style="width:auto; height:600px;">
        <ace:AceoffixCtrl ID="AceoffixCtrl1" runat="server" onload="Aceoffix1_Load">
        </ace:AceoffixCtrl>
    </div>
    </form>
</div>
