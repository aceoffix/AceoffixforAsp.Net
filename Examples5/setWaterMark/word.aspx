<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="setWaterMark_word" %>
...
<title>Acesoft Corporation -  Set watermark in Word document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Set watermark in Word document</em></strong></span></div>
        <div class="right">
...
<form id="form1" runat="server">
 Key code:Aceoffix.WordWriter.WordDocument wd = new Aceoffix.WordWriter.WordDocument();<br/>
	wd.WaterMark.Text = "Aceoffix";<br/>
