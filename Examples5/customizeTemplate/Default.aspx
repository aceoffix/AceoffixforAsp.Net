<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="customizeTemplate_Default" %>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>How user makes or customizes the Word template and how developer uses the template to generate the formatted Word document</em></strong></span></div>
        <div class="right">
...
<div id="inner-wrap" class="clearfix">
   ...
   <div class="zz-content mc clearfix pd-28">
			<div class="demo mc">
				<h2 class="fs-16">
					Using Word template customized by users to generate document dynamically.
				</h2>
				
				<p>
					Note: To simplify the code, data filled in this template is not from database, but constant.  
				</p>
			...
			<div class="zz-talbeBox mc" style="text-align:center;">
				...
				<div style=" text-align:right; height:40px; vertical-align:middle;">
				    <a href="javascript:AceBrowser.openWindowModeless('template.aspx','width=1200px;height=800px;');"><span style=" color:blue;"><strong>User customizes the Word template</strong></span></a>&nbsp;&nbsp;&nbsp;
				</div>
				<table class="zz-talbe">
					<thead>
						<tr >		
							<th width="30%" style="text-align:center;border: 1px solid #999999;">
								Demonstration     
							</th>
							<th width="10%" style="text-align:center;border: 1px solid #999999;">
							   Location
							</th>
							<th width="60%" style="text-align:center;border: 1px solid #999999;">
								Operation
							</th>
					...
					<tbody>
						<tr>
							<td style="text-align:center;border: 1px solid #999999;">Generate document dynamically with three OpenModes.</td>
							<td style="text-align:center;border: 1px solid #999999;">word.aspx</td>
							<td style="text-align:center;border: 1px solid #999999;">
								<a href="javascript:AceBrowser.openWindowModeless('word.aspx?type=1','width=1200px;height=800px;');"><span style=" color:blue;">Fill&Edit</span></a>
								&nbsp;&nbsp;&nbsp;
								<a href="javascript:AceBrowser.openWindowModeless('word.aspx?type=2','width=1200px;height=800px;');"><span style=" color:blue;">Fill&Read-Only</span></a>
								&nbsp;&nbsp;&nbsp;
								<a href="javascript:AceBrowser.openWindowModeless('word.aspx?type=3','width=1200px;height=800px;');"><span style=" color:blue;">Fill&Submit</span></a>
							</td>
						</tr>
					</tbody>
				</table>
