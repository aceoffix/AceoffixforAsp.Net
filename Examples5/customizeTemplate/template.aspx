<%@ Page Language="C#" AutoEventWireup="true" CodeFile="template.aspx.cs" Inherits="customizeTemplate_Template" %>
  ...
  <script type="text/javascript">
      ...
      function checkBkConts() {
        ...
        function ShowDefineDataRegions() {
            document.getElementById("AceoffixCtrl1").ShowHtmlModelessDialog("DataRegionDlg.htm", "parameter=xx", "left=300px;top=390px;width=600px;height=410px;frame:no;");

        }
        function ShowDefineDataTags() {
            document.getElementById("AceoffixCtrl1").ShowHtmlModelessDialog("DataTagDlg.htm", "parameter=xx", "left=300px;top=390px;width=500px;height=410px;frame:no;");
        }
        function Close() {
