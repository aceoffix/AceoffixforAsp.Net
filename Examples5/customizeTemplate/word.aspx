<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="customizeTemplate_word" %>
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
   <script type="text/javascript">
       function Save2() {
           document.getElementById("AceoffixCtrl1").Alert("This demo shows how to generate document by online editing, and the document cannot be saved.");
       }
       function Save() {
