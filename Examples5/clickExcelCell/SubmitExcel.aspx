<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubmitExcel.aspx.cs" Inherits="clickExcelCell_SubmitExcel" %>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Capture the click event on the cells in Excel</em></strong></span></div>
        <div class="right">
   	    ...
   	    function OnCellClick(Celladdress, value, left, bottom) {
   	        ...
   	        while (i < 5) {
   	            ...
   	            if (Celladdress == "Sheet1!$B$" + (4 + i)) {
   	                var strRet = document.getElementById("AceoffixCtrl1").ShowHtmlModalDialog("select.aspx", "", "left=" + left + "px;top=" + bottom + "px;width=320px;height=200px;frame=no;");
   	                if (strRet != "") {
   	                    return (strRet);
   	                }
   	                else {
