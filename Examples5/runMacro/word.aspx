...
<title>Acesoft Corporation - Run macros in document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Run macros in document</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
  <script language="javascript" type="text/javascript">
      function Button1_onclick() {
          document.getElementById("AceoffixCtrl1").RunMacro("myfunc", document.getElementById("textarea1").value);
      }
...
Selection.TypeText " Demo Text "
    ...
    <input id="Button1" type="button" value="Run Macro myfunc" onclick="return Button1_onclick()" />
