<%@ Page Language="C#" AutoEventWireup="true" CodeFile="callvba.aspx.cs" Inherits="excel_callvba" %>
...
<title>Acesoft Corporation - Use JavaScript to call VBA interface of Excel application</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Use JavaScript to call VBA interface of Excel application</em></strong></span></div>
        <div class="right">
   ...
   <form id="form1" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function CallVBA1() {
            ...
            AceoffixCtrl1.DocumentObject.Sheets(1).Range("A1:A6").Interior.Color = 200 + (160 * 256) + (35 * 65536); //RGB
        }
        function CallVBA2() {
            var AceoffixCtrl1 = document.getElementById("AceoffixCtrl1");
            AceoffixCtrl1.DocumentObject.Application.Selection.Rows(1).EntireRow.Insert();
        }
</script>
