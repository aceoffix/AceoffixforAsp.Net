<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewexcel.aspx.cs" Inherits="excel_viewexcel" %>
...
<title>Acesoft Corporation - View Excel document in read-only mode</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em> View Excel document in read-only mode</em></strong></span></div>
        <div class="right">
