<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editexcel.aspx.cs" Inherits="excel_editexcel" %>
...
<title>Acesoft Corporation - Edit Excel document online</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Edit Excel document online</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SaveAsHTML() {
            ...
            window.location = "viewhtml.aspx?mht=../doc/editexcel.htm";
        }
