<%@ Page Language="C#" AutoEventWireup="true" CodeFile="excelsubmit.aspx.cs" Inherits="excel_excelsubmit" %>
...
<title>Acesoft Corporation - Excel spreadsheet used as an input form</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Excel spreadsheet used as an input form</em></strong></span></div>
        <div class="right">
...
<!--************** End of AceoffixCtrl JavaScript ************************-->
  ...
  <div style="width:auto; height:600px;">
      <ace:AceoffixCtrl ID="AceoffixCtrl1" runat="server" Menubar="False" 
          ...
          Theme="Office2007" BorderStyle="BorderThin">
      </ace:AceoffixCtrl>
  </div>
  </form>	
</div>
