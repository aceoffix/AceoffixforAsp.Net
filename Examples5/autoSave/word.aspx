<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="beforeBrowserClosed_word" %>
...
<title>Save document automatically</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>View Word document in read-only mode</em></strong></span></div>
        <div class="right">
...
<div class="container left">
 ...
 Key code: document.getElementById("AceoffixCtrl1").AutoSaveDocument();
...
<script language="javascript" type="text/javascript">
    ...
    function AutoSaveDocument() {
        document.getElementById("AceoffixCtrl1").AutoSaveDocument();
    }
</script>
<script type="text/javascript">
   	 var id=window.setInterval("AutoSaveDocument()",60000); 
   </script>
<!--************** End of AceoffixCtrl JavaScript ************************-->

  <form id="form1" runat="server">
  <div style="width:auto; height:600px;">
      <ace:AceoffixCtrl ID="AceoffixCtrl1" runat="server" onload="AceoffixCtrl1_Load" 
