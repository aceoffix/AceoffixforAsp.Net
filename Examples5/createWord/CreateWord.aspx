...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
 <script type="text/javascript">
     ...
     function BeforeDocumentSaved() {
         var str = document.getElementById("FileSubject").value;
         if (str.length <= 0) {
             document.getElementById("AceoffixCtrl1").Alert("Enter a Filename");
             return false
         }
         else
             return true;
				...
				<div id="textcontent" style="width: 1000px; height: 800px;">
					...
					<div>
						...
						<input name="FileSubject" id="FileSubject" type="text"
							...
							style="width: 180px;" value="Enter a Filename" />
						<input type="button" onclick="Save()" value="Save" />
						<input type="button" onclick="Cancel()" value="Cancel" />
					</div>
					<div>
					Key code: AceoffixCtrl1.CreateNewDocument("Tom", Aceoffix.DocumentVersion.Word2003);	&nbsp;
...
<a href="http://www.aceoffix.com/index.php/sitemap/">Sitemap</a>
		<br>
		Copyright 2016, <strong>Aceoffix</strong>. All rights reserved.
    </div>
</div>
