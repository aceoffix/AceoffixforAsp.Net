...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Create document</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
 <script type="text/javascript">
     ...
     function lostFocus() {
         var str = document.getElementById("FileSubject").value;
         if (str.length <= 0) {
             document.getElementById("FileSubject").value = "Enter a Filename";
         }
     }
        ...
        <div class="demo mc" style="text-align:center;">
            ...
            <center><table class="text" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    ...
                    <td align="center">
                        <input name="FileSubject" id="FileSubject" type="text" onfocus="getFocus()" onblur="lostFocus()"
                            class="boder" style="width: 180px;" value="Enter a Filename" />
                    </td>
                    <td style="width: 221px;">
                        &nbsp;
                        <asp:Button ID="btnCreate0" runat="server" Text="Create" Width="86px" OnClick="btnCreate0_Click" />
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;<a href="javascript:AceBrowser.openWindowModeless('CreateWord.aspx', 'width=1200px;height=800px;');" style=" color:Blue; text-decoration:underline;"> Create Document</a>
                        </td>
                    <td style="width: 221px;">
                        &nbsp;&nbsp;
                    </td>
