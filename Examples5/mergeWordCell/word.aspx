<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="mergeWordCell_word" %>
...
<title>Acesoft Corporation - Merge cells in the table in Word document by programming and set the style of the text in cell</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Merge cells in the table in Word document by programming and set the style of the text in cell</em></strong></span></div>
        <div class="right">
...
<div class="container left">
  <form id="form1" runat="server">
    Key code: table.OpenCellRC(1, 1).MergeTo(1,5);
