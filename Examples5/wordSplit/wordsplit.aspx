<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wordsplit.aspx.cs" Inherits="wordSplit_wordsplit" %>
...
<title>Acesoft Corporation - Split word document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Split word document</em></strong></span></div>
        <div class="right">
...
<div class="container left">
 Demo Remarks<br/>
When clicking "Save" button, <br/>
AceoffixCtrl will save the content of the three DataRegions (ACE_Paragraph1, ACE_Paragraph2, ACE_Paragraph3)<br/> 
as three single documents (Paragraph1.doc, Paragraph2.doc, Paragraph3.doc) to "split/doc" folder on server disk.<br/>
Only the Ultimate edition of Aceoffix supports Word document splitting,<br/>
 and the OpenModeType of the AceoffixCtrl must be Aceoffix.OpenModeType.docSubmitForm.<br/>
  The property of DataRegion shall be set as dataRegion1.SubmitAsFile=true;.<br/>
