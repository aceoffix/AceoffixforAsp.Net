<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="jsWordAddBM_word" %>
...
<title>Acesoft Corporation - Insert bookmark in where the cursor is in Word document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Insert bookmark in where the cursor is in Word document</em></strong></span></div>
        <div class="right">
...
<div class="container left">
 ...
 <form id="form1" runat="server">
    ...
    <div style=" font-size:small; color:Red;">
        <label>Bookmark Name:</label><input id="txtBkName" type="text" value="test" /><br/>
       <label>Bookmark Text:</label><input id="txtBkText" type="text" value="[test]" /><br/>
    </div>
    <input id="Button1" type="button" onclick="addBookMark();" value="Insert Bookmark" />
    <input id="Button2" type="button" onclick="delBookMark()" value="Delete Bookmark" />
     ...
     <script type="text/javascript">
         ...
         function addBookMark() {
             var mac = "Function myfunc()" + " \r\n"
                    ...
                    + "End Function " + " \r\n";
             document.getElementById("AceoffixCtrl1").RunMacro("myfunc", mac);
         }
