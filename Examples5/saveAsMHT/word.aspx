...
<title>Acesoft Corporation -  Save as MHT</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Save as MHT</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
  <form id="form1" runat="server">
    ...
    Key code:document.getElementById("AceoffixCtrl1").SaveDocumentAsMHT();<br/>
    You can find the MHT file in the "saveAsMHT/doc" folder. 
<script language="javascript" type="text/javascript">
    ...
    function SaveAsMHT() {
        document.getElementById("AceoffixCtrl1").SaveDocumentAsMHT();
        document.getElementById("AceoffixCtrl1").Alert("Save successful!");
        // window.open("doc/introduce.mht" + "?r=" + Math.random());
    }
