<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="applyTemplate_Default" %>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Apply the predefined template to current document by one click</em></strong></span></div>
        <div class="right">
...
<script type="text/javascript">
   ...
   <div class="zz-content mc clearfix pd-28">
			<div class="demo mc">
				<h3 class="fs-16">
					<center>Aceoffix is used in the process of finalizing a document</center>
				</h3>
				...
				<table style="width: 80%;text-align: center;margin:auto">
					<thead>
						<tr onmouseover="onColor(this);" onmouseout="offColor(this);">		
							<th width="20%" style="text-align:center;border: 1px solid #999999;">
								Document Name
							</th>
							<th width="20%" style="text-align:center;border: 1px solid #999999;">
								Create Date
					...
					<tbody>
						<tr>
							<td style="text-align:center;border: 1px solid #999999;">Document</td>
							<td style="text-align:center;border: 1px solid #999999;">05/30/2013</td>
							<td style="text-align:center;border: 1px solid #999999;">
								<a href="javascript:AceBrowser.openWindowModeless('edit.aspx', 'width=1200px;height=800px;');"><span style=" color:Green;">Edit Draft</span></a>&nbsp;&nbsp;&nbsp;
								<a href="javascript:AceBrowser.openWindowModeless('apply.aspx', 'width=1200px;height=800px;');"><span style=" color:Green;">Apply Template</span></a>&nbsp;&nbsp;&nbsp;
								<a href="javascript:AceBrowser.openWindowModeless('readOnly.aspx', 'width=1200px;height=800px;');"><span style=" color:Green;">Official Document</span></a>
							</td>
						</tr>
					</tbody>
				</table>
