<%@ Page Language="C#" AutoEventWireup="true" CodeFile="readOnly.aspx.cs" Inherits="applyTemplate_readOnly" %>
        ...
        <div id="textcontent" style="width: 1000px; height: 800px;">
            <div class="flow4">
                <span style="width: 100px;">
                    </span><strong>Official Document</strong>
          
            </div>
    <!--************** Start of AceoffixCtrl JavaScript ************************-->       
    <script language="javascript">
        function ShowDialog1() {
            document.getElementById("AceoffixCtrl1").ShowDialog(2);
        }
        function ShowDialog2() {
            document.getElementById("AceoffixCtrl1").ShowDialog(5);
        }
        function ShowDialog3() {
            document.getElementById("AceoffixCtrl1").ShowDialog(4);
        }
