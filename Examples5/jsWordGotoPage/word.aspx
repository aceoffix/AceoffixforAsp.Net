<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="jsWordGotoPage_word" %>
...
<title>Acesoft Corporation -  Jump to the specified page in Word</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Jump to the specified page in Word</em></strong></span></div>
        <div class="right">
  ...
  <script type="text/javascript">
        function gotoPage(num) {
            var sMac = "function myfunc()" + "\r\n"
                        ...
                        + "     Msgbox \"The page number is out of range. The page count of this article is \" & Application.Selection.Information(4) & \".\"" + "\r\n"
                        + "  End If " + "\r\n"
        ...
        function Button1_onclick() {
            ...
            if ("" == Trim(num)) {
                document.getElementById("AceoffixCtrl1").Alert("Please enter the page number");
                return;
            }
            if (isNaN(num)) {
                document.getElementById("AceoffixCtrl1").Alert("Can only enter the Numbers");
                return;
            }
            gotoPage(num);
        }
...
<!--************** End of AceoffixCtrl JavaScript ************************-->	
    <div style="font-size:12px; line-height:20px; border-bottom:dotted 1px #ccc;border-top:dotted 1px #ccc; padding:5px;">
     <span style="color:red;"> Operation instrution:</span>Please enter the page number to jump to the specified page. <br/>Page number:
     <input id="pageNum" type="text" value="2" />
        <input id="Button1" type="button" value="Jump" onclick="return Button1_onclick()" />
     <br />
   </div>
