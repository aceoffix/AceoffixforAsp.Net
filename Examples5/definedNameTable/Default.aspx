...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Assign the table with defined name in Excel template</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
 <div style="text-align:left;margin-top:30px;">
    	...
    	<a href="javascript:AceBrowser.openWindowModeless('ExcelFill.aspx','width=1200px;height=800px;');">openTableByDefinedName</a>
  	</div>
    <div style="text-align:left; margin-top:30px;">
...
Note: openTable method is not applicable in this case.</span><br/><br/>
    	<a href="javascript:AceBrowser.openWindowModeless('ExcelFill2.aspx?temp=temp1.xls','width=1200px;height=800px;');">Excel template I</a><br/><br/>
    	<a href="javascript:AceBrowser.openWindowModeless('ExcelFill2.aspx?temp=temp2.xls','width=1200px;height=800px;');">Excel template II</a>
    </div>
    <div style="text-align:left; margin-top:30px;">
    	...
    	<a href="javascript:AceBrowser.openWindowModeless('ExcelFill6.aspx','width=1200px;height=800px;');">Open the template (test4.xls)</a><br/><br/>
    	<a href="javascript:AceBrowser.openWindowModeless('ExcelFill4.aspx','width=1200px;height=800px;');">Use openTable method-----Tables are overlapped.</a><br/><br/>
    	<a href="javascript:AceBrowser.openWindowModeless('ExcelFill5.aspx','width=1200px;height=800px;');">Use openTableByDefineName method-----Tables are separated.</a>
    </div>
