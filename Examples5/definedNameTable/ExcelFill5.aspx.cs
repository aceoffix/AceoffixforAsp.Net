...
public partial class definedNameTable_ExcelFill5 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Aceoffix.ExcelWriter.Table table = sheet.OpenTableByDefinedName("report", 4, 5, true);
        int rowCount = 12;
        ...
        Aceoffix.ExcelWriter.Table table2 = sheet.OpenTableByDefinedName("report2", 4, 5, true);
        int rowCount2 = 12;
