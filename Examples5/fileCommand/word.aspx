<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="fileCommand_word" %>
...
<title>Acesoft Corporation -  Control save, save as and print function</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Control save, save as and print function</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
 <form id="form1" runat="server">
    ...
    Check the "File" menu, "Save", "Save As", "Page Setup", and "Print" turn to grey, and Ctrl+S is disabled too.
<script language="javascript" type="text/javascript">
    function AfterDocumentOpened() {
        document.getElementById("AceoffixCtrl1").SetEnableFileCommand(3, false); // Disable Save
        document.getElementById("AceoffixCtrl1").SetEnableFileCommand(4, false); // Disable Save As
        document.getElementById("AceoffixCtrl1").SetEnableFileCommand(5, false); //Disable Print
        document.getElementById("AceoffixCtrl1").SetEnableFileCommand(6, false); // Disable Print Setup
    }
</script>
