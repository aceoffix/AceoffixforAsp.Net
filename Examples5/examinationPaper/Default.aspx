...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Dynamically generate an examination paper in Word document</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
 <script type="text/javascript">
     ...
     function button2Click() {
		...
		<form id="form1" name="form1" method="post" action="Compose.aspx">
			...
			<input type="button" onclick="button2Click();" id="Button2" value="Generate Paper by C# code" /><span style="color:Red;"></span></div>
		</form>
