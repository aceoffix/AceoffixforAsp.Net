<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="beforeAndAfterSave_word" %>
...
<title>Acesoft Corporation -  Trigger an event before or after saving the document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Trigger an event before or after saving the document</em></strong></span></div>
        <div class="right">
...
<script language="javascript" type="text/javascript">
    ...
    function BeforeDocumentSaved() {
        document.getElementById("AceoffixCtrl1").Alert("To save the file");
        return true;
    }
    function AfterDocumentSaved(IsSaved) {
        if (IsSaved) {
            document.getElementById("AceoffixCtrl1").Alert("Save successful!");
        }
    } 
</script>
