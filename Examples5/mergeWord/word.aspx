<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="mergeWord_word" %>
...
<title>Acesoft Corporation - Merge word document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Merge word document</em></strong></span></div>
        <div class="right">
...
<!--************** End of AceoffixCtrl JavaScript ************************-->
    ...
    Key Code:<br/>
 Aceoffix.WordWriter.DataRegion dataRegion1 = doc.OpenDataRegion("Paragraph1");<br/>
        dataRegion1.Value = "[word]doc/paragraph1.doc[/word]";<br/>
