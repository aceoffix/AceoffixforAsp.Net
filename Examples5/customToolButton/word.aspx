...
<title>Acesoft Corporation -  Add a button to the custom toolbar of Aceoffix</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Add a button to the custom toolbar of Aceoffix</em></strong></span></div>
        <div class="right">
...
<div class="container left">
  ...
  <form id="form1" runat="server">
    ...
    Click "Test" in custom toolbar to check the result.
<!--************** Start of AceoffixCtrl JavaScript ************************-->
<script type="text/javascript">
    function CustomButton() {
        document.getElementById("AceoffixCtrl1").Alert("This is a CustomButton!");
    } 
</script>
