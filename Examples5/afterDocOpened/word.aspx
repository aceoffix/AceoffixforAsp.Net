<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="afterDocOpened_word" %>
...
<title>Acesoft Corporation -  Add a JavaScript event triggered by AceoffixCtrl in the page after opening the document</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Add a JavaScript event triggered by AceoffixCtrl in the page after opening the document</em></strong></span></div>
        <div class="right">
...
<form id="form1" runat="server">
  The JavaScript is added to the document opened event by programming. 
<script language="javascript" type="text/javascript">
    function AfterDocumentOpened() {
        document.getElementById("AceoffixCtrl1").Alert("Hello");
    }
