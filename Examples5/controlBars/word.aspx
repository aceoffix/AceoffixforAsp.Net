<%@ Page Language="C#" AutoEventWireup="true" CodeFile="word.aspx.cs" Inherits="controlBars_word" %>
...
<title>Acesoft Corporation -  Hide caption bar, menu bar, custom toolbar and Office toolbar</title>
...
<li class="page_item menu-item-17"><a href="http://www.aceoffix.com/index.php/about-us/">About Us</a></li>
    ...
    <br/>
    <div class="container left">
        <div class="left"><span>Current Page: <a href="../Default.aspx" title="Examples Center">Example Center</a> &gt;</span><span><strong><em>Hide caption bar, menu bar, custom toolbar and Office toolbar</em></strong></span></div>
        <div class="right">
...
<!--************** Start of AceoffixCtrl JavaScript ************************-->
  <form id="form1" runat="server">
   ...
   Hide the caption bar, menu bar, custom toolbar and Office toolbar.  Each bar can be hidden respectively.
